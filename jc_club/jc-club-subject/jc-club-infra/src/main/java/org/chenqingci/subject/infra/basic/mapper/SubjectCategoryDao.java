package org.chenqingci.subject.infra.basic.mapper;
...
public interface SubjectCategoryDao {
     ...
     * @return 实例对象
     */
    SubjectCategory queryById(@Param("id") Long id);
    ...
    List<SubjectCategory> queryCategory(Long parentId);
}
